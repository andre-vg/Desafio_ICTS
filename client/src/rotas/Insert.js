  ...
  return (
    ...
    <div className="App">
      ...
      <form className="crud-form">
        ...
        <br/>
        <textarea type="text" className='dsc_produto_box' name="dsc_produto" placeholder="Descrição" onChange={(e) =>{
        ...
        <br/>
        <button onClick={submitProduto} type="submit" className="btn btn-outline-dark">Enviar</button>
